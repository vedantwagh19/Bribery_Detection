...
Click on the "Open In Colab" button on the top left corner of README. and follow the steps :<br>
Follow the steps provided on the colab<br>
Enjoy the Result !!! <br>
...
python detect.py --video ./data/video/test.mp4 --output ./outputs/demo.avi --model yolov4

# Run yolov4 deep sort object tracker on webcam (set video flag to 0)
python detect.py --video 0 --output ./outputs/webcam.avi --model yolov4
```
...
python detect.py --weights ./checkpoints/yolov4-tiny-416 --model yolov4 --video ./data/video/test.mp4 --output ./outputs/tiny.avi --tiny
```
...
To filter a custom selection of classes all you need to do is comment out line 202 and uncomment out line 205 of [detect.py](https://github.com/vedantwagh19/Bribery_Detection/blob/main/detect.py) Within the list ``allowed_classes`` just add whichever classes you want the tracker to track. The classes can be any of the 80 that the model is trained on, see which classes you can track in the file [data/classes/coco.names](https://github.com/vedantwagh19/Bribery_Detection/blob/main/data/classes/coco.names)
